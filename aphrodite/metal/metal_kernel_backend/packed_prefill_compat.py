...
def apply_packed_rope(
    ...
    if rope_fn is None and rotary_emb is None:
        # Some mlx_lm models, e.g. Afmoe/Trinity, use NoPE on selected
        # attention layers and expose ``rope = None`` for those layers.
        return queries, keys
